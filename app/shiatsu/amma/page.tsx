		...
		<main>
			...
			<section className="container space-y-4 max-w-4xl mx-auto p-4 mb-12">
				...
				<p className="prose prose-neutral dark:prose-invert">
					...
					cette parenthèse de bien-être, accessible à tous, à tout moment. </p>
					<p className="prose prose-neutral dark:prose-invert">Nous sommes fiers de proposer cette technique rapide et efficace, idéale pour les personnes
...
<div>
				...
				<p className="prose prose-neutral dark:prose-invert">
					...
					à 30 minutes, cette technique cible les zones de tension dans le dos, les épaules, le cou, les bras et la tête. </p>
					<p className="prose prose-neutral dark:prose-invert">Le praticien utilise des pressions, des percussions, des étirements
				...
				<p className="prose prose-neutral dark:prose-invert">Le massage sur chaise est plus qu&apos;une simple pause détente ; il offre de véritables bénéfices pour la santé :</p>
				<ul>
